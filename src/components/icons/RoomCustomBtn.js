    ...
    <svg xmlns="http://www.w3.org/2000/svg" width={200} height={73} {...props}>
      ...
      >
        <g data-type="innerShadowGroup">
          <g filter="url(#roomCustomBtn_svg__a)" transform="translate(107 614)">
            <rect
              data-name="\u9577\u65B9\u5F62 298"
              width={200}
              height={70}
          ...
          <g filter="url(#roomCustomBtn_svg__b)" transform="translate(107 614)">
            <rect
              data-name="\u9577\u65B9\u5F62 298"
              width={200}
              height={70}
...
export default SvgRoomCustomBtn;
